...
--https://stackoverflow.com/questions/24997131/pairwise-array-sum-aggregate-function
--For faster solution, there is https://github.com/pjungwir/aggs_for_vecs but requires a custom db docker image to compile the extension
