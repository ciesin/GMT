//derived from https://api.maptiler.com/maps/topo/style.json?key=get_your_own_D6rA4zTHduk6KOKTXzGB
//look to have attributes nigeria.mbtiles.info.ts
export const osmStyles: any = {
  "id": "topo",
  "name": "Topo",
  "zoom": 1,
  "pitch": 0,
  ...
  "layers": [{
    ...
    "id": "landcover_grass",
    "type": "fill",
    "paint": {"fill-color": "rgba(222, 226, 191, 1)", "fill-opacity": 0.6, "fill-antialias": false},
    "filter": ["any", ["==", "subclass", "park"], ["==", "subclass", "village_green"], ["==", "class", "grass"], ["==", "class", "farmland"]],
    "layout": {"visibility": "visible"},
    "source": "openmaptiles",
    "maxzoom": 22,
    "minzoom": 9,
    ...
    "id": "landcover_ice",
    "type": "fill",
    "paint": {"fill-color": "rgba(255, 255, 255, 1)", "fill-opacity": 1, "fill-antialias": false},
    ...
    "id": "landcover_sand",
    "type": "fill",
    "paint": {"fill-color": "rgba(232, 214, 38, 1)", "fill-opacity": 0.3, "fill-antialias": false},
    ...
    "type": "fill",
    "paint": {"fill-color": "rgba(222, 226, 191, 1)", "fill-opacity": {"stops": [[8, 0.6], [9, 0.2]]}},
    ...
    "type": "fill",
    "paint": {"fill-color": "rgba(202, 214, 166, 1)", "fill-opacity": 1},
    ...
    "type": "fill",
    "paint": {"fill-color": "rgba(191, 202, 155, 1)", "fill-opacity": 1},
    ...
    "type": "fill",
    "paint": {"fill-color": "rgba(191, 186, 171, 1)", "fill-opacity": {"stops": [[8, 0.4], [9, 0.1], [9.1, 0.4]]}},
    ...
    "type": "fill",
    "paint": {
      "fill-color": {"stops": [[12, "rgba(179, 179, 179, 1)"], [16, "rgba(232, 230, 223, 1)"]]},
      "fill-opacity": 0.5
    },
    "filter": ["all", ["in", "class", "industrial", "commercial", "retail", "stadium", "college", "university", "school", "garages", "dam"]],
    "layout": {"visibility": "visible"},
    "source": "openmaptiles",
    "maxzoom": 22,
    "minzoom": 10,
    ...
    "paint": {
      ...
      "line-width": 1.3,
      "line-opacity": {"stops": [[7, 0.2], [10, 0.6]]}
    },
    ...
    "id": "contour",
    "type": "line",
    "paint": {"line-color": "rgba(181, 129, 100, 1)", "line-width": 0.8, "line-opacity": 0.5},
    ...
    "type": "line",
    "paint": {
      "line-color": {"stops": [[6, "rgba(103, 166, 196, 1)"], [8, "rgba(196, 229, 236, 1)"], [9, "rgba(103, 166, 196, 1)"]]},
    ...
    "id": "waterway_other",
    "type": "line",
    "paint": {"line-color": "rgba(103, 166, 196, 1)", "line-width": {"base": 1.3, "stops": [[13, 0.5], [20, 12]]}},
    "filter": ["all", ["!=", "class", "river"], ["!=", "brunnel", "tunnel"], ["!=", "intermittent", 1]],
    ...
    "type": "fill",
    "paint": {"fill-color": "rgba(163, 201, 220, 1)", "fill-opacity": 1},
    ...
    "id": "ferry",
    "type": "line",
    "paint": {"line-color": "rgba(47, 136, 183, 1)", "line-width": 1.1, "line-dasharray": [2, 2]},
    ...
    "type": "line",
    "paint": {"line-color": "#e9ac77", "line-width": {"base": 1.2, "stops": [[8, 1.5], [20, 21]]}, "line-opacity": 1},
    ...
    "paint": {
      "line-color": "#e9ac77",
      "line-width": {"base": 1.2, "stops": [[5, 0.4], [6, 0.7], [7, 1.75], [20, 22]]},
      "line-dasharray": [0.5, 0.25]
    },
    ...
    "type": "line",
    "paint": {"line-color": "#fff4c6", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 12]]}},
    "filter": ["all", ["==", "brunnel", "tunnel"], ["in", "class", "secondary", "tertiary"]],
    "layout": {"line-join": "round"},
    "source": "openmaptiles",
    "metadata": {},
    ...
    "id": "road_area_bridge",
    "type": "fill",
    "paint": {"fill-color": "rgba(246, 241, 229, 0.6)", "fill-antialias": true},
    ...
    "id": "road_pier",
    "type": "line",
    "paint": {"line-color": "rgba(232, 230, 223, 1)", "line-width": {"base": 1.2, "stops": [[15, 1], [17, 4]]}},
    ...
    "filter": ["all", ["==", "$type", "Polygon"], ["!=", "brunnel", "bridge"], ["!in", "class", "bridge", "pier"]],
    "layout": {"visibility": "visible"},
    "source": "openmaptiles",
    "metadata": {},
    "source-layer": "transportation"
    ...
    "paint": {
      ...
      "line-width": {"base": 1.2, "stops": [[15, 1.3], [16, 4], [20, 11]]}
    },
    "filter": ["all", ["!in", "brunnel", "bridge", "tunnel"], ["in", "class", "track"]],
    "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
    "source": "openmaptiles",
    "minzoom": 13,
    "metadata": {},
    ...
    "filter": ["all", ["!in", "brunnel", "bridge", "tunnel"], ["in", "class", "service"]],
    "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
    "source": "openmaptiles",
    "metadata": {},
    "source-layer": "transportation"
    ...
    "paint": {
      "line-color": "#e9ac77",
      "line-width": {"base": 1.2, "stops": [[12, 1], [13, 3], [14, 6], [20, 23]]},
      "line-opacity": 1
    },
    ...
    "paint": {
      "line-color": "rgba(181, 178, 175, 1)",
      "line-width": {"base": 1.2, "stops": [[12, 0.5], [13, 1], [14, 4], [20, 20]]},
      "line-opacity": {"stops": [[12, 0], [12.5, 1]]}
    },
    ...
    "paint": {
      "line-color": "#e9ac77",
      "line-width": {"base": 1.2, "stops": [[5, 0.4], [6, 0.7], [7, 1.75], [20, 23]]},
      "line-opacity": 1
    },
    ...
    "type": "line",
    "paint": {"line-color": "#fc8", "line-width": {"base": 1.2, "stops": [[12.5, 0], [13, 1.5], [14, 2.5], [20, 19]]}},
    "filter": ["all", ["!in", "brunnel", "bridge", "tunnel"], ["==", "class", "motorway"], ["==", "ramp", 1]],
    "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
    "source": "openmaptiles",
    "minzoom": 12,
    ...
    "type": "line",
    "paint": {"line-color": "#fea", "line-width": {"base": 1.2, "stops": [[5, 0], [7, 1], [20, 19]]}},
    "filter": ["all", ["!in", "brunnel", "bridge", "tunnel"], ["in", "class", "primary", "trunk"]],
    "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
    "source": "openmaptiles",
    "metadata": {},
    ...
    "type": "line",
    "paint": {
      "line-color": {"base": 1, "stops": [[5, "rgba(251, 183, 100, 1)"], [6, "rgba(255, 204, 136, 1)"]]},
      "line-width": {"base": 1.2, "stops": [[5, 0], [7, 1], [20, 18]]}
    },
    "filter": ["all", ["!in", "brunnel", "bridge", "tunnel"], ["==", "class", "motorway"], ["!=", "ramp", 1]],
    "layout": {"line-cap": "round", "line-join": "round", "visibility": "visible"},
    ...
    "type": "line",
    "paint": {
      "line-color": {"base": 1, "stops": [[5, "hsl(26, 87%, 62%)"], [6, "#fc8"]]},
      "line-width": {"base": 1.2, "stops": [[5, 0], [7, 1], [20, 18]]},
      "line-dasharray": [2, 2]
    },
    ...
    "paint": {
      ...
      "line-width": {"base": 1.2, "stops": [[12, 0.5], [13, 1], [14, 4], [20, 25]]},
      "line-opacity": {"stops": [[12, 0], [12.5, 1]]}
    },
    ...
    "type": "line",
    "paint": {"line-color": "#fea", "line-width": {"base": 1.2, "stops": [[6.5, 0], [7, 0.5], [20, 12]]}},
    "filter": ["all", ["==", "brunnel", "bridge"], ["in", "class", "secondary", "tertiary"]],
    "layout": {"line-join": "round"},
    "source": "openmaptiles",
    "metadata": {},
    ...
    "id": "cablecar",
    "type": "line",
    "paint": {"line-color": "rgba(153, 153, 153, 1)", "line-width": {"base": 1, "stops": [[11, 1], [19, 2.5]]}},
    ...
    "paint": {
      ...
      "line-opacity": {"base": 1, "stops": [[0, 0.6], [4, 0.9], [12, 0.9], [18, 0.6]]}
    },
    ...
    "filter": ["all", ["==", "$type", "Point"], ["==", "rank", 1], ["==", "class", "peak"]],
    "layout": {
      "icon-size": 1,
      "text-font": ["Noto Sans Regular"],
      "text-size": 0,
    ...
    "filter": ["all", ["==", "$type", "Point"], ["==", "rank", 1], ["==", "class", "volcano"]],
    "layout": {
      "icon-size": 1,
      "text-font": ["Noto Sans Regular"],
      "text-size": 0,
    ...
    "id": "place_other",
    "type": "symbol",
    "paint": {"text-color": "rgba(47, 49, 60, 1)", "text-halo-color": "rgba(255,255,255,0.8)", "text-halo-width": 1.2},
    ...
    "id": "place_state",
    "type": "symbol",
    "paint": {"text-color": "rgba(94, 95, 101, 1)", "text-halo-color": "rgba(255,255,255,0.7)", "text-halo-width": 1},
    ...
    "id": "continent",
    "type": "symbol",
    "paint": {"text-color": "rgba(59, 60, 58, 1)", "text-halo-color": "rgba(255,255,255,0.7)", "text-halo-width": 1},
  ...
  "version": 8,
  "metadata": {"mapbox:type": "template", "openmaptiles:version": "3.x"}
}
